...
> ## 📣 ใบสั่งงานใหม่ 2026-08-06 — **รองรับ AI หลายเจ้า** (อ่านก่อนเริ่มงาน)
>
> เช้านี้ **เครดิตบัญชี Anthropic หมด → ทั้งบ้านหยุดพร้อมกัน** (ทีมใน d_CEO · QC gate ·
> บรรณารักษ์คลัง · เอเจนต์ค้นคว้า) และหยุดแบบ**เงียบ** — งานไปกอง `rejected` ปนกับงานที่ QC
> ตีกลับจริง ๆ · **คีย์บนเครื่องมี 2 ตัวและตอบ 400 เครดิตไม่พอทั้งคู่** (ตัวหนึ่งใช้ร่วมกัน 5 ที่)
>
> **มติ Vinit: ทุกระบบที่เรียก LLM ต้องสลับผู้ให้บริการได้โดยไม่แก้โค้ดธุรกิจ**
> รายละเอียด + งานของรีโปนี้ + เกณฑ์ verify: **`D:\Dev_Proj\0_CORE\d_CEO\docs\ORDER_TICKET_2026-08-06.md`**
>
> 🔑 หัวใจคือ **แยกชนิด error ให้ถูก**: `credit/401/403` = บัญชีใช้ไม่ได้ → สลับทันที ·
> `429/529` = ชั่วคราว → ถอยแล้วลองใหม่ · `400` อื่น = โจทย์ผิด → **ห้ามสลับ** (สลับไปก็ผิดเหมือนกัน)
