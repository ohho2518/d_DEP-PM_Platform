...
0. ✅ ~~รวม `new-project-studio` เข้ามา (ADR-05)~~ **ทำครบ S1-S3 แล้ว 2026-08-14** —
   เหลือของที่ยังไม่ได้ทำโดยตั้งใจ: ปุ่ม "เขียนผลงานลงไฟล์" บนหน้า task detail
   (endpoint พร้อมแล้ว `POST /:id/deliverables` — ตอนนี้เรียกผ่าน API) ·
   และ **ยังไม่ได้ลองกับไฟล์ดีไซน์ก้อนใหญ่จริง** (PDF/DOCX เทสต์ครอบแค่ md/รูป)
