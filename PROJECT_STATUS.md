...
1.1 **แยกโทเคนตามผู้ให้บริการ** (§5 ของใบสั่งงาน — ทั้งบ้านยังไม่มีใครทำ) · ตอนนี้ `LLMReply`
   มี `provider`/`model` แล้ว = มีที่เกาะ · มีแบบร่าง 2 ทางเลือกจากรอบ Team Mode (project `aab43c6a`)
