...
2. **วัดผล `needs_human` กับงานหลายชิ้น** — ตรวจกับโมเดลจริงแล้ว 1 งาน (ผ่าน) แต่ยังไม่เห็น
   พฤติกรรมในโปรเจกต์ที่มีทั้งงานทำได้และงานที่ติด · จุดที่ต้องเฝ้า: reviewer จะใช้
   `needs_human` **เกินจำเป็น**กับงานที่จริง ๆ แล้วทำได้ไหม (เท่ากับโยนงานให้คนเร็วเกินไป)
3. **ทบทวนกติกา escalation กับงานเอกสาร** — ดูอีก 1-2 รอบก่อนสรุปว่าปัญหาเดิมหายจริง
   (สถิติสะสมใน runbook §7)
