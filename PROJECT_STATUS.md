...
1. **วัดผลกติกาห้ามกุหลักฐานกับงานจริง** — กติกาเข้า prompt แล้ว แต่ยังไม่ได้พิสูจน์ว่า
   ทำให้ agent เลิกแต่งจริงไหม (unit test ล็อกได้แค่ว่า "ข้อความกติกาอยู่ใน prompt")
   · รอบทดสอบหน้าให้ดูว่ามี "ต้องการข้อมูลจากคน:" หรือป้าย `[ตัวอย่างสมมติ]` โผล่ในผลงานไหม
